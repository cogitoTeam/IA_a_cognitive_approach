...
\storeglosentry{Choices_FOL}{name=Choices\_FOL, description={Version logique de Percept.Choices contenant un Cbs, le plateau courant, et une liste de Option\_FOL}}

\storeglosentry{FOL_objects}{name={FOL\_objects}, description={Package contenant l’ensemble des classes représentant des informations en logique du premier ordre.}}

\storeglosentry{Option}{name={Action.Option}, description={Pair Action.Move-BoardMatrix correspondant à une action et son résultat}}

\storeglosentry{Option_FOL}{name=Option\_FOL, description={Version logique de Action.Option contenant une action, son résultat et une liste de formes présentes dans ce plateau résultant}}

\storeglosentry{CompleteBoardState}{name=CompleteBoardState, description={Classe correspondant à un plateau du jeu sous forme logique (cf. \vref{subsection_cbs_rpbs})}}

\storeglosentry{RelevantPartialBoardState}{name=RelevantPartialBoardState, description={Classe représentant la configuration d'une sous-partie d'un plateau comme une règle(cf. \vref{subsection_cbs_rpbs})}}
