...
\storeglosentry{Choices}{name=Choices, description={Classe héritier de la classe abstraite Percept, contenant un ensemble de pairs action (Action.Move) et résultat (BoarMatrix)}}
