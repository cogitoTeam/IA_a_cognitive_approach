...
En séparant l'agent de son environnement nous gagnons polyvalence et la flexibilité. D'une part l'agent pourrait être aussi bien un humain qu'une machine, que ce soit notre système ou bien un algorithme de l'état de l'art tel \texsc{MiniMax}\footnote{Stratégie MiniMax : minimisation de la perte maximum (dans le pire des cas).}. Les testes en cours de développement, ainsi que les évaluations à terme.
