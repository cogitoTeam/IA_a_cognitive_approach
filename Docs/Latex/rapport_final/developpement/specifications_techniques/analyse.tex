...
\begin{itemize}
  ...
  \item \class{Choices\_FOL} (\texttt{FOL\_objects}) : version conversion d'un \gls{Choices} sous forme de logique du première ordre avec, en supplément, une liste de formes pertinentes associée à chaque plateau du paquet,
  \item \class{CompleteBoardState} (\texttt{FOL\_objects}) : version logique du premier ordre de
