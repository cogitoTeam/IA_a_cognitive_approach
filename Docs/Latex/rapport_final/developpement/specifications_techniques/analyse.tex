...
\begin{itemize}
  ...
  \item \class{BoardMatrix} (bibliothèque \gls{game_logic}) : plateau sous forme matriciel,
  \item \class{Choices\_FOL} (\texttt{FOL\_objects}) : version convertie par l'analyseur de Choices (même structure, attributs décrits par des formules logiques) avec, en supplément, une liste de formes pertinentes associée à chaque plateau du paquet,
