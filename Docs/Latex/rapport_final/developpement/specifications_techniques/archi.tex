...
\end{itemize}
Notons que rien d'empêche les confrontations entre deux clients machines avec des IA différentes, un client humain et un client machine ou bien deux clients humains. Par la suite nous nous focaliserons entièrement sur l'implémentation de ce derniers : tout cette architecture fut, après tout, implémentée pour lui seul.