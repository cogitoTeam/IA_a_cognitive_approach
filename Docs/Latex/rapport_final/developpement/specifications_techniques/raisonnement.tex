...
Le module de raisonnement a été implémenté en trois classes comme la montre la figure \ref{class_diag_reasoning_engine}. La classe \class{ReasoningEngine} sert d'interface avec les autres modules de \cogito{}. 
