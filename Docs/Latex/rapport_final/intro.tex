...
Le but de ce TER fut d'implémenter un modèle d'intelligence artificiel basé sur une approche cognitive. L'agent développé devait être capable d'apprendre en faisant des liens entre concepts sémantiques tirés de son environnent. 
