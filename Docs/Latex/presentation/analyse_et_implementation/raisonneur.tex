...
\begin{frame}{Raisonneur}{Moteur d'introspection}
	\begin{minipage}{1\textwidth}
		\begin{minipage}{0.25\textwidth}
			\only<1|handout:0>{\includegraphics[width=\textwidth]{img/screenshoot/cbs0_reco0}	}
			\only<2|handout:0>{\includegraphics[width=\textwidth]{img/screenshoot/cbs0_reco1}	}
			\only<3-4|handout:1>{\includegraphics[width=\textwidth]{img/screenshoot/cbs0_reco2}	}
		\end{minipage}
	...
	\begin{minipage}{1\textwidth}
		\begin{minipage}{0.25\textwidth}
			\only<1|handout:0>{\includegraphics[width=\textwidth]{img/screenshoot/cbs1_reco0}	}
			\only<2-3|handout:0>{\includegraphics[width=\textwidth]{img/screenshoot/cbs1_reco1}	}
			\only<4|handout:1>{\includegraphics[width=\textwidth]{img/screenshoot/cbs1_reco2}	}		
		\end{minipage}
		\begin{minipage}{0.75\textwidth}
