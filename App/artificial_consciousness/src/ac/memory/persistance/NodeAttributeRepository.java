...
public class NodeAttributeRepository {
     ...
     * @param index
     */
    public NodeAttributeRepository(GraphDatabaseService graphDb,
            Index<Node> index) {
    ...
    public NodeAttribute createAttribute(RelevantPartialBoardState object)
        ...
        try {
            ...
            attributeRefNode.createRelationshipTo(newNodeAttribute,
                    RelTypes.ATTR);
    ...
    public NodeAttribute getAttributeById(long id) {
        ...
        if (attribute == null) {
            ...
            throw new IllegalArgumentException(NodeAttribute.TYPE_VALUE + "["
                    + id + "] not found");
        }
    ...
    public void deleteAttribute(NodeAttribute attribute) {
        logger.debug("Opening transaction to delete attribute "
                + attribute.getId());
        Transaction tx = graphDb.beginTx();
        try {
            ...
            nodeAttribute.getSingleRelationship(RelTypes.ATTR,
    ...
    public Iterable<NodeAttribute> getAllNodeAttributes() {
        ...
        return new IterableWrapper<NodeAttribute, Relationship>(
            ...
            @Override
            protected NodeAttribute underlyingObjectToObject(
                    Relationship attributeRel) {
